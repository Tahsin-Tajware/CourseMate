...
import { getAllUnis } from 'bd-instituition-list-by-solutya'
...
//const universitiesList = getAllUnis();
...
const Register = () => {
  ...
  useEffect(() => {
    // Find the selected university from the universitiesList
    const selectedUniversity = universitiesList.find(
      (uni) => uni.name === formData.varsity
    );


  }, [formData.varsity, universitiesList]);
